...
void verticalLine(Tigr *img, uint16_t x1, uint16_t y1, uint16_t y2, uint16_t r, TPixel color, LINE_PLOT_CALLBACK plot = NULL);

void horizontalLine(Tigr *img, uint16_t x1, uint16_t y1, uint16_t x2, uint16_t r, TPixel color, LINE_PLOT_CALLBACK plot = NULL);
